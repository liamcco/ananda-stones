...
export default async function Home() {
  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col items-center md:block">
      ...
      <h2 className="mt-10 md:mt-24 font-bold text-gray-700 text-3xl">
        Alla stenar
      </h2>
      <div className="mt-5 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {stones.map((stone) => (
          <Link
            ...
            className="border-2 border-gray-500 rounded-lg p-1 hover:scale-105 hover:border-green-500 transition max-w-sm mx-4"
          >
